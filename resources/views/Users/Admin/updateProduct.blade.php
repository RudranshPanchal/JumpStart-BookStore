    ...
    <div class="row">
        ...
        <div class="col col-sm-6" id="createm">
            <form action="{{ route('admin#updateProduct', $editProduct->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-floating mb-3">
                <input type="text" class="form-control" id="floatingInput" placeholder="Type" name="product_type" value="{{ old('product_type', $editProduct->product_type) }}">
                <label for="name">Product Type</label>
                </div>

                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingInput" placeholder="Price" name="product_price" value="{{ old('product_price', $editProduct->product_price) }}">
