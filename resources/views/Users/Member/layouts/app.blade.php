...
<header class="site-navbar" role="banner">
    ...
    <div class="container">
      ...
      <div class="col-11 col-xl-2">
        <h1 class="mb-0 site-logo"><a style="color: rgb(0, 0, 0)" href="#" class="text-black mb-0">JumpStart-BookStore</a></h1>
      </div>
      <div class="col-12 col-md-10 d-none d-xl-block">
        ...
        <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
          ...
          <ul class="dropdown arrow-top" style="color: black">
...
<!-- Content -->
<section class="py-4" style="background: linear-gradient(44.8deg, rgba(255, 136, 102, 0.67) -53.1%, rgba(255, 221, 136, 0.28) 49%);">
  >
    <div class="container">
        @yield('content')
    </div>
