...
@section('content')
  ...
  <body style="background-image: url(../img/wwwssoiu.png); background-size:cover;">
...
<h3 class="text-center pt-5" style="color: rgb(0 0 0);
padding: 10px;
background-color: #00d7e854;">
  <b>Register</b>
</h3>
    <div class="container-fluid" style="background-color: rgba(0, 0, 0, 0.352)" >
      <div class="row">
        <div class="col col-sm-8" id="form" style="padding-left: 20%;  padding-top:10px;  padding-bottom:10px;">
            ...
            <div class="member box">
              ...
              <button type="submit" class="btn btn-blue" style="float: right; color:white; background-color:rgb(5, 72, 255)">Register</button>
              <button type="reset" class="btn btn-red !important" style="float: right;margin-right: 20px; color:white; background-color:rgb(255, 5, 5)">Clear</button>
            </div>
          </form>
          </div>
        </div>
